                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', $user->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('fn') is-invalid @enderror" id="fn" name="fn" value="{{ $user->fn }}" required>
                                @error('fn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('gen') is-invalid @enderror" id="gen" name="gen" required>
                                    ...
                                    <option value="Male" @if ($user->gen == 'Male') selected @endif>Male</option>
                                    <option value="Female" @if ($user->gen == 'Female') selected @endif>Female</option>
                                </select>
                                @error('gen')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
